export function NavBar(props) {
    ...
    return (
        <div className="z-[5] fixed top-0 w-full flex justify-around md:justify-between px-2 md:px-24 py-2 duration-700 " style={{height: '10vh'}}>
            <div className="flex justify-between items-center px-2 md:w-1/3 text-subtextcol duration-700">
                <div className='font-extrabold titlefont text-navtextcol text-xl titlefont'>Dawson Li</div>
            </div>
